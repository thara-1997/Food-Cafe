...
class ProfileTableViewHeader: UIView {
    ...
    private let joinDateImageView: UIImageView = {
        ...
        imageView.image = UIImage(systemName: "calendar.badge.clock", withConfiguration: UIImage.SymbolConfiguration(pointSize: 14))
...
//        sectionStack.backgroundColor = .systemPink
    ...
    private func configureConstraints(){
        ...
        let joinDateLabelConstraints = [
            joinDateLabel.leadingAnchor.constraint(equalTo: joinDateImageView.trailingAnchor, constant: 4),
       ...
       let followersCountLabelConstraints = [
        ...
        let sectionStackConstraints = [
            ...
            sectionStack.topAnchor.constraint(equalTo: followingCountLabel.bottomAnchor, constant: -8),
