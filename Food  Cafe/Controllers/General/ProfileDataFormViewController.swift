    ...
    private func configureConstraints(){
       ...
       let avatarPlaceHolderImageViewConstraints = [
        ...
        let displayNameTextFieldConstraints = [
            ...
            displayNameTextField.topAnchor.constraint(equalTo: avatarPlaceHolderImageView.bottomAnchor, constant: 30),
       ...
       let bioTextViewContraints = [
        ...
        NSLayoutConstraint.activate(bioTextViewContraints)
